...
/**
 * Visitor for modify method instructions (remove, replace, process exception
 * handlers)
 */
public class ModVisitor extends AbstractVisitor {
                        ...
                        if (callMth.isConstructor()) {
                            ...
                            if (co.isSuper()) {
                                try {
                                    ...
                                    Log.w(tag, "Can't inline args into super call: " + inv + ", mth: " + mth);
    ...
    /**
     * Replace insn by index i in block, for proper copy attributes, assume
     * attributes are not overlap
     */
